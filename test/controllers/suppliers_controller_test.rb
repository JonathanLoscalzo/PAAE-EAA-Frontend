...
class SuppliersControllerTest < ActionController::TestCase
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post :create, supplier: { name: @supplier.name, product_request_url: @supplier.product_request_url }
    end
  ...
  test "should update supplier" do
    patch :update, id: @supplier, supplier: { name: @supplier.name, product_request_url: @supplier.product_request_url }
    assert_redirected_to supplier_path(assigns(:supplier))
  end
